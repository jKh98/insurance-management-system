...
public class Consts {
    ...
    public static final String TABLE_CONSTRAINT_TRAVEL = "fk_travel_policy_id";
    ...
    public static final String TABLE_CONSTRAINT_MOTOR = "fk_motor_policy_id";
    ...
    public static final String TABLE_CONSTRAINT_BENEFICIARY = "fk_medical_policy_id";
